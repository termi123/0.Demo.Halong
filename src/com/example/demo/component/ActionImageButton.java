	...
	class OnTouchListenerCahngeBackground implements OnTouchListener{
		...
		public boolean onTouch(View v, MotionEvent event) {
			switch (event.getAction())
	        {
	            ...
	            {
	            	ActionImageButton.this.setBackgroundResource(com.example.demo.halong.R.color.url_color);
	                return false;
	            }
		        case MotionEvent.ACTION_UP:
	            {
	            	ActionImageButton.this.setBackgroundResource(R.color.black_overlay);
	                return false;
	            }
	        }
			return false;
