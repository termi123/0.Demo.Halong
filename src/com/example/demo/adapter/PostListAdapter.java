...
import com.example.demo.util.ImageQuality;
...
public class PostListAdapter extends BaseAdapter {
	...
	public PostListAdapter(Context context, List items) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = mInflater.inflate(R.layout.row_post_list, null);
		...
		if (s.get_RATE().equals("0")) {
			holder.ratingBar.setRating(3);
		} else {
			float star = Float.parseFloat(s.get_RATE());
