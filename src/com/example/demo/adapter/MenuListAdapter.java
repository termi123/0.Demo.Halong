...
public class MenuListAdapter extends ArrayAdapter<LeftMenuBean> {

	LayoutInflater inf;
	LinkedList<LeftMenuBean> objects;
	boolean main;

	public MenuListAdapter(Context context, int resource, int textViewResourceId,
			LinkedList<LeftMenuBean> objects, boolean main) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		ViewHolder holder;
		LeftMenuBean s = objects.get(position);
		if (convertView == null) {
